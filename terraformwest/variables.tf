...
variable "ecs_image_url" {
  ...
  type        = string
  default     = "353766797959.dkr.ecr.us-east-1.amazonaws.com/calc-repo:v1.2"
}

# This variable defines the ECR image URL.
variable "ecs_image_url_match" {
  description = "The desired ECR image URL for match container image."
  type        = string
  default     = "387544295844.dkr.ecr.us-east-1.amazonaws.com/customer/match:1.0"
}
